    ...
    const applyJobHandler = async () => {
        try {
            ...
            if (res.data.success) {
                ...
                dispatch(setSingleJob(updatedSingleJob)); //help us for real time UI update
        ...
        <div className="max-w-7xl mx-auto my-10">
            <div className="flex items-center justify-between">
                ...
                <Button
                    ...
                    className={`rounded-lg ${isApplied ? 'bg-gray-600 text-white cursor-not-allowed' : 'bg-[#7209b7]  text-white hover:bg-[#7109b7e8]'}`}>
            ...
            <div className="my-4">
                ...
                <h1 className="font-bold my-1">Tatal Applicants: <span className="pl-4 font-normal text-gray-800">{singleJob?.applications?.length}</span></h1>
